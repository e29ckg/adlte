...
\yiister\gentelella\widgets\Menu::widget(
        [
            "items" => [
                ["label" => "Home", "url" => "?r=site/index", "icon" => "home"],
                ["label" => "หนังสือเวียน", "url" => ["judgement/index"], "icon" => "files-o"],
                ...
                [
                    ...
                    "url" => "#",
                    "items" => [
                        ["label" => "Menu", "url" => ["judgement/index"]],
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        ...
                                        <li><a href="?r=site/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                        </li>
                                    </ul>
                                </li>
