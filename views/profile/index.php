...
//                    'style' => 'width:100px;',
                ...
                <ul class="list-group list-group-unbordered">
                    ...
                    <li class="list-group-item">
                        <b>กรุ๊ปเลือด</b> <a class="pull-right"><?= $model->bloodtype ?></a>
                    </li>
                    <li class="list-group-item">
                        <b>โทรศัพท์</b> <a class="pull-right"><?= $model->phone ?></a>
                    </li>
                </ul>

                <a href="#" class="activity-update-link btn btn-primary btn-block" data-id="<?= $model->id ?>"><b>แก้ไขข้อมูล</b></a>
            </div>
            <!-- /.box-body -->
        </div>
        <!-- /.box -->
    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#activity" data-toggle="tab" aria-expanded="false">ข้อมูลพื้นฐาน</a></li>
                <li class=""><a href="#timeline" data-toggle="tab" aria-expanded="false">ประวัติการอบรม</a></li>
